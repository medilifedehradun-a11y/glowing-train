...
export const site = {
  ...
  description:
    'Medilife Superspeciality Hospital in Dehradun offers advanced urology, orthopedics, general surgery, ENT, oncology, plastic surgery and general medicine care with experienced specialists, modern operation theatres and round-the-clock emergency services.',
